        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div>
                ...
                <input id="name" name="name" type="text" required
                       class="mt-1 block w-full px-4 py-3 bg-white/10 border border-gray-300 rounded-lg shadow-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#008080] focus:border-[#008080] transition-all duration-200 @error('name') border-red-500 @enderror"
                       value="{{ old('name') }}"
            ...
            <!-- تأكيد كلمة المرور -->
            <div>
                <label for="password_confirmation" class="block text-sm font-medium text-white">تأكيد كلمة المرور</label>
                <input id="password_confirmation" name="password_confirmation" type="password" required
                       class="mt-1 block w-full px-4 py-3 bg-white/10 border border-gray-300 rounded-lg shadow-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#008080] focus:border-[#008080] transition-all duration-200"
            ...
            <div>
                ...
                <input id="MobileNumber" name="MobileNumber" type="tel" required
                       class="mt-1 block w-full px-4 py-3 bg-white/10 border border-gray-300 rounded-lg shadow-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#008080] focus:border-[#008080] transition-all duration-200 @error('MobileNumber') border-red-500 @enderror"
            ...
            <div class="text-center mt-4">
                <a href="{{ route('login') }}" class="text-sm text-[#008080] hover:text-[#006666] transition-all duration-200">
                    لديك حساب؟ <span class="font-semibold">سجل الدخول</span>
                </a>
            </div>
        </form>
    </div>
